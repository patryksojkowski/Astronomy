...
namespace AstronomyCalculationsLibrary.Common
{
    public struct OrbitalElements
    {
        ...
        public OrbitalElements(decimal _longAscendingNode, decimal _inclination, decimal _peryhelion, decimal _eccentricity, decimal _meanAnomaly, decimal _semimajorAxis)
        {
