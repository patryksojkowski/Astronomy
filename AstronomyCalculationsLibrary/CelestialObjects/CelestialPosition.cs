...
namespace AstronomyCalculationsLibrary.CelestialObjects
{
  ...
  {
    public CelestialPosition(string name, Func<decimal, decimal> ascedningNode, Func<decimal, decimal> inclination,
    ...
    public OrbitalElements GetOrbitalElements(DateTime date)
    {
      ...
      return new OrbitalElements(LongAscedingNode(d), Inclination(d), Peryhelion(d), Eccentricity(d), MeanAnomaly(d),
        SemimajorAxis(d));
    }
