...
{
  internal class PlutoPosition : ICelestialPosition
  {
    private readonly Func<decimal, decimal> FP = d => 238.95m + 0.003968789m * d;

    private readonly Func<decimal, decimal> FS = d => 50.03m + 0.033459652m * d;
...
#if DEBUG
      Console.WriteLine(
        $"Pluto ecliptic Earth  Xe= {pos.X - earthPos.X}, Ye = {pos.Y - earthPos.Y}, Ze = {pos.Z - earthPos.Z}");
#endif
