...
namespace AstronomyCalculationsLibrary.CelestialObjects
{
  internal class SunPosition : CelestialPosition
  {
    ...
    public SunPosition SunInstance;

    public SunPosition(string name, Func<decimal, decimal> ascedningNode, Func<decimal, decimal> inclination,
    ...
    {
      if (!DateChanged(date)) return sunPosition;
