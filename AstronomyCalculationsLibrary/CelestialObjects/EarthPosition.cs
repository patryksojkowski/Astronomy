...
namespace AstronomyCalculationsLibrary.CelestialObjects
{
  public class EarthPosition : CelestialPosition
  {
    ...
    public static EarthPosition EarthInstance;

    public EarthPosition(string name, Func<decimal, decimal> ascedningNode, Func<decimal, decimal> inclination,
    ...
    {
      if (!DateChanged(date)) return earthPosition;
